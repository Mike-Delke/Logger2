...
Public Class Log_Book_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Road_Runner_Logger.Log Book Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLog_Book_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Log_Book_Report = New Log_Book_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
